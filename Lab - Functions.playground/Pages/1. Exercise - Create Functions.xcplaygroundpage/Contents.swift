...
func introduceMySelf() {
    print("Je m'appelle Elliot KNIGHT et je suis étudiant à l'AFExtended de Simplon.co")
}
...
func magicEightBall() {
    ...
    if randomNum == 1 {
        ...
        print("J'ai deux euros")
    }else if randomNum < 2{
        print("Je suis un grand garçon")
    }else {
        print("J'ai zéro euro je suis pas encore Jeff Bezzos")
    }
}
