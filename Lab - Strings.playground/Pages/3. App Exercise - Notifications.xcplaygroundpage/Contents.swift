/*:
 ...
 - callout(App Exercises): The exercises below make Swift feel more applicable by helping you implement features of a fitness tracking app.
...
print("Congrats \(fullName) ! You beat your previous daily high score of \(previousBest) steps by waling \(newBest) steps yesterday ")
